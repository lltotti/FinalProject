<template>
  ...
  <div v-if="item.is_complete===showComplete" class="bg-gray-100 flex flex-row border w-2/4 ">
   <!-- Card -->
    <div @click="editTasks(item.id)" class="w-80 rounded-2xl border shadow py-12 px-8 hover:-translate-y-1 hover:shadow-2xl delay-75 duration-100" :id="item.title">
    <!-- Title -->
    <p class="text-3xl text-gray-700 font-semibold">{{item.title}} </p>
    <div class="flex flex-row space-x-6" >
           <button @click="editTasks(item.id)" class="mt-10 w-full py-3 rounded-xl border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-gray-50"> Edit</button>
           <button v-if="showComplete===false" @click="completeTask(item.id)" class="mt-10 w-full py-3 rounded-xl border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-gray-50"> Complete</button>
           <button v-if="showComplete===true" @click="completeTask(item.id)" class="mt-10 w-full py-3 rounded-xl border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-gray-50"> Re-Open</button>
           <button @click="deleteTask(item.id)" class="mt-10 w-full py-3 rounded-xl border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-gray-50"> Delete</button>
