...
<!-- <div class="relative border border-black">
    <div class="h-screen w-full z-10 inset-0 overflow-y-auto border-8 border-black">
        <div class="absolute w-full h-full inset-0 bg-gray-500 opacity-25 border-6 border-black">
        </div>
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 border-4 border-black">
                        ...
                        <div class="p-2">
                            <div class="text-center mb-4 opacity-90">
                                <a href="#" class="block relative">
                                    <img alt="profil" src="../assets/yo.jpeg" class="mx-auto object-cover rounded-full h-16 w-16 "/>
